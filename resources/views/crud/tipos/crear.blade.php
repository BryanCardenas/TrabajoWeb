...
<div class="container mt-5">
    <form method="POST" action="{{route('tipos.store')}}" enctype="multipart/form-data">
        ...
        <div class="form-group col-6">
            ...
            <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Ingrese el nombre del tipo">
        </div>

        <div class="form-group col-6">
            <label for="precio">Precio</label>
            <input type="number" id="precio" name="precio" class="form-control" placeholder="Ingrese el precio sin puntos ni comas (Ej: 50000)">
        </div>

        <div class="form-group col-6 text-center row justify-content-end ">
            <button type="submit" class="btn btn-primary bg-success  text-center"> <i class="fas fa-check"></i> Agregar tipo</button>
