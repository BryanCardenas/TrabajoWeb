...
<div class="container pt-4">
    ...
    <div class="row justify-content-end">
        ...
        <a target="_blank" href="{{ route('generar-pdf') }}" class="btn btn-warning mr-3"><i class="fas fa-file-alt"></i> Generar Reporte</a>
        @endif
                ...
                <table class="table table-bordered  table-hover">
                    <thead class="thead-light text-center">
                        <tr>
                            ...
                            <th class="bg-primary text-white">Cliente que arrienda</th>
